...
var proxy = __webpack_require__(45);
var toInlineStyle = __webpack_require__(35);
...
var sanitize = __webpack_require__(46);
var getPath = __webpack_require__(47);
var getProperty = __webpack_require__(48);
        ...
        var handler = {
            get: function get(target, property) {
                ...
                if (property === '__getTarget') {
                    ...
                    return function (i) {
                        ...
                        var parentPath = getPath(target, '__getParent', path).split('.');
            ...
            set: function set(target, property, value, receiver) {
                ...
                if (targetProp !== value || originalChange === false || property === 'length' && target instanceof Array && target.__length !== value) {
                    ...
                    var _currentPath = getPath(target, property, path);

                    if (typeof _manipulate === 'function') {
                        value = _manipulate(value, receiver[property], _currentPath);
                    }
                    ...
                    if (typeof observable.beforeChange === 'function' && observable.checkBeforeChange !== _currentPath) {
                        observable.checkBeforeChange = _currentPath;
                        var res = observable.beforeChange(changes);
                        if (res === false) {
                            observable.checkBeforeChange = '';
                            return false;
                        ...
                        if (foundObservable) {
                            ...
                            setTimeout(function () {
                                ...
                                if (typeOfTargetProp === 'object' && targetProp !== null) {
                                    ...
                                    for (var i = 0, _l = keys.length; i < _l; i++) {
                                    ...
                                    (function iterate(target) {
                                        var keys = Object.keys(target);
                                        for (var _i = 0, _l2 = keys.length; _i < _l2; _i++) {

                                            var _property = keys[_i];
                                    ...
                                    (function iterate(obj) {
                                        ...
                                        var keys = Object.keys(obj);
                                        for (var _i2 = 0, _l3 = keys.length; _i2 < _l3; _i2++) {
                                            var objProp = obj[keys[_i2]];
                                            if (objProp instanceof Object && objProp !== null) iterate(objProp);
                                        }

                                        // if there are any existing target objects (objects that we're already observing)...
                                        var c = -1;
                                        for (var _i3 = 0, _l4 = targets.length; _i3 < _l4; _i3++) {
                                            if (obj === targets[_i3]) {
                                                c = _i3;
                                                break;
                                            }
